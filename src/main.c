...
int main() {
    int escolha;
    unsigned int id;
    char nome[BUFFER_SIZE], cpf[SMALL_BUFFER_SIZE], telefone[SMALL_BUFFER_SIZE];
    char cep[SMALL_BUFFER_SIZE], alergias[BIG_BUFFER_SIZE], deficiencias[BIG_BUFFER_SIZE];
    ...
    do {
        ...
        switch (escolha) {
            case 1:
                ...
                paciente = novoPaciente(0, nome, cpf, telefone, cep, alergias, deficiencias, idade, genero);
                if (paciente != NULL) {
            ...
            case 3:
                ...
                agendamento = novoAgendamento(0, paciente, medico, dataHora, status);
                if (agendamento != NULL) {
            ...
            case 6:
                ...
                if (agendamento != NULL) {
                    ...
                    printf("Status: %s\n", (agendamento->status == agendado) ? "Agendado" : (agendamento->status == finalizado) ? "Finalizado" : "Cancelado");
                    printf("Paciente:\n");
