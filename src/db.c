...
Agendamento *novoAgendamento(int id, Paciente *paciente, Medico *medico,
  ...
  agendamento->dataHora = (char *)malloc(sizeof(char) * SMALL_BUFFER_SIZE);
...
int inserirMedico(Medico *medico) {
  ...
  rc = sqlite3_bind_text(stmt, 2, medico->especialidade, -1, SQLITE_TRANSIENT);
...
int inserirPaciente(Paciente *paciente) {
  ...
  rc = sqlite3_bind_text(stmt, 3, paciente->telefone, -1, SQLITE_TRANSIENT);
  rc = sqlite3_bind_text(stmt, 4, paciente->cep, -1, SQLITE_TRANSIENT);
  rc = sqlite3_bind_text(stmt, 5, paciente->alergias, -1, SQLITE_TRANSIENT);
  rc = sqlite3_bind_text(stmt, 6, paciente->deficiencias, -1, SQLITE_TRANSIENT);
...
int inserirAgendamento(Agendamento *agendamento) {
  ...
  char *sql = "INSERT INTO Agendamento(medico_id,paciente_id,dataHora,status) "
  ...
  rc = sqlite3_bind_text(stmt, 3, agendamento->dataHora,
                         sizeof(char) * SMALL_BUFFER_SIZE, SQLITE_TRANSIENT);
